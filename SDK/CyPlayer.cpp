...
int CyPlayer::getNumWorldSpell(){

    return m_pPlayer->getNumWorldSpell();

}

void CyPlayer::setNumWorldSpell(int iNum){

    m_pPlayer->setNumWorldSpell(iNum);

}

int CyPlayer::getNumTohoUnitLimit(){

    return m_pPlayer->getNumTohoUnitLimit();

}

void CyPlayer::setNumTohoUnitLimit(int iNum){

    m_pPlayer->setNumTohoUnitLimit(iNum);

}

int CyPlayer::getNumTohoUnit(){

    return m_pPlayer->getNumTohoUnit();

}

void CyPlayer::setNumTohoUnit(int iNum){

    m_pPlayer->setNumTohoUnit(iNum);

}

int CyPlayer::getMysteryiumFlag(){

    return m_pPlayer->getMysteryiumFlag();

}

void CyPlayer::setMysteryiumFlag(int iNum){

    m_pPlayer->setMysteryiumFlag(iNum);

}

int CyPlayer::getAIPromotionRoute(){

    return m_pPlayer->getAIPromotionRoute();

}

void CyPlayer::setAIPromotionRoute(int iNum){

    m_pPlayer->setAIPromotionRoute(iNum);

}

int CyPlayer::getNumMyLove(){

    return m_pPlayer->getNumMyLove();

}

void CyPlayer::setNumMyLove(int iNum){

    m_pPlayer->setNumMyLove(iNum);

}

int CyPlayer::getNumMadeMyLove(){

    return m_pPlayer->getNumMadeMyLove();

}

void CyPlayer::setNumMadeMyLove(int iNum){

    m_pPlayer->setNumMadeMyLove(iNum);

}

void CyPlayer::resetGreatPeopleThreshold(){
