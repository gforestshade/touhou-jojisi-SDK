...
//FfH: End Add
	...
	//東方叙事詩用
	int getNumWorldSpell();
	void setNumWorldSpell(int iNum);
	int getNumTohoUnitLimit();
	void setNumTohoUnitLimit(int iNum);
	int getNumTohoUnit();
	void setNumTohoUnit(int iNum);
	int getMysteryiumFlag();
	void setMysteryiumFlag(int iNum);
	int getAIPromotionRoute();
	void setAIPromotionRoute(int iNum);
	int getNumMyLove();
	void setNumMyLove(int iNum);
...
//FfH: End Add
	...
	//東方叙事詩用
	int m_iNumWorldSpell;
	int m_iNumTohoUnitLimit;
	int m_iNumTohoUnit;
	int m_iMysteryiumFlag;
