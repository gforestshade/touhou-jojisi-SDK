...
void CyPlotPythonInterface1(python::class_<CyPlot>& x)
{
	...
	x
		...
		//ìåï˚èñéñéçóp
        .def("setNumCirnoFreeze", &CyPlot::setNumCirnoFreeze, "void (int iNum)")
        .def("getNumCirnoFreeze", &CyPlot::getNumCirnoFreeze, "int ()")
        .def("setOriginalBounu", &CyPlot::setOriginalBounu, "void (int iNum)")
        .def("getOriginalBounu", &CyPlot::getOriginalBounu, "int ()")
        .def("setOriginalTerrain", &CyPlot::setOriginalTerrain, "void (int iNum)")
        .def("getOriginalTerrain", &CyPlot::getOriginalTerrain, "int ()")
        .def("setNumVortexTrun", &CyPlot::setNumVortexTrun, "void (int iNum)")
        .def("getNumVortexTrun", &CyPlot::getNumVortexTrun, "int ()")
	;
}
