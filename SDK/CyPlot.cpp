...
//“Œ•û–Ž–Ž—p
void CyPlot::setNumCirnoFreeze(int iNum){

    m_pPlot->setNumCirnoFreeze(iNum);

}

int CyPlot::getNumCirnoFreeze(){

    return m_pPlot->getNumCirnoFreeze();

}

void CyPlot::setOriginalBounu(int iNum){

    m_pPlot->setOriginalBounu(iNum);

}

int CyPlot::getOriginalBounu(){

    return m_pPlot->getOriginalBounu();

}

void CyPlot::setOriginalTerrain(int iNum){

    m_pPlot->setOriginalTerrain(iNum);

}

int CyPlot::getOriginalTerrain(){

    return m_pPlot->getOriginalTerrain();

}

void CyPlot::setNumVortexTrun(int iNum){

    m_pPlot->setNumVortexTrun(iNum);

}

int CyPlot::getNumVortexTrun(){

    return m_pPlot->getNumVortexTrun();
