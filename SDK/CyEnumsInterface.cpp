...
void CyEnumsPythonInterface()
{
	...
	python::enum_<WidgetTypes>("WidgetTypes")
		...
		//ìåï˚èñéñéçóp
		.value("WIDGET_PEDIA_JUMP_TO_TOHOUNIT", WIDGET_PEDIA_JUMP_TO_TOHOUNIT)
		.value("WIDGET_PEDIA_CAL_UP", WIDGET_PEDIA_CAL_UP)
		.value("WIDGET_PEDIA_CAL_DOWN", WIDGET_PEDIA_CAL_DOWN)
	...
	python::enum_<ButtonPopupTypes>("ButtonPopupTypes")
		...
		.value("BUTTONPOPUP_TEST", BUTTONPOPUP_TEST)
	...
	python::enum_<GameOptionTypes>("GameOptionTypes")
		...
		//ìåï˚èñéñéçóp
		.value("GAMEOPTION_NO_PYRAMID", GAMEOPTION_NO_PYRAMID)
		.value("GAMEOPTION_NO_GREAT_WALL", GAMEOPTION_NO_GREAT_WALL)
		.value("GAMEOPTION_NO_STATUE_OF_ZEUS", GAMEOPTION_NO_STATUE_OF_ZEUS)
		.value("GAMEOPTION_STRONG_AI", GAMEOPTION_STRONG_AI)
		.value("GAMEOPTION_MUSOU", GAMEOPTION_MUSOU)
		.value("GAMEOPTION_MULTI", GAMEOPTION_MULTI)
		.value("GAMEOPTION_ORENOYOME", GAMEOPTION_ORENOYOME)
		.value("GAMEOPTION_SPELL_ONLY_AI", GAMEOPTION_SPELL_ONLY_AI)
		.value("GAMEOPTION_AI_NOT_SPEL_CAST", GAMEOPTION_AI_NOT_SPEL_CAST)
		.value("GAMEOPTION_NO_EIYAGAESI", GAMEOPTION_NO_EIYAGAESI)
		.value("GAMEOPTION_PEACE_OF_BC1000", GAMEOPTION_PEACE_OF_BC1000)
		.value("GAMEOPTION_NO_CIVIC_CHANGE_RESOLUTION", GAMEOPTION_NO_CIVIC_CHANGE_RESOLUTION)
		.value("GAMEOPTION_NO_MANHATTAN", GAMEOPTION_NO_MANHATTAN)
		.value("GAMEOPTION_NO_SPLITEMPIRE", GAMEOPTION_NO_SPLITEMPIRE)
		.value("GAMEOPTION_NO_OUKA", GAMEOPTION_NO_OUKA)
	...
	python::enum_<CivilopediaPageTypes>("CivilopediaPageTypes")
		...
		//ìåï˚èñéñéçóp
		.value("CIVILOPEDIA_PAGE_TOHOUNIT", CIVILOPEDIA_PAGE_TOHOUNIT)
	...
	python::enum_<TohoFlags>("TohoFlags")
		.value("TOHOFLAGS_AMENOUZUME", TOHOFLAGS_AMENOUZUME)
		.value("TOHOFLAGS_RAIKO_TATEKAE", TOHOFLAGS_RAIKO_TATEKAE)
		.value("TOHOFLAGS_TURNCOUNT_X", TOHOFLAGS_TURNCOUNT_X)
		.value("NUM_TOHOFLAGS", NUM_TOHOFLAGS)
		;
}
