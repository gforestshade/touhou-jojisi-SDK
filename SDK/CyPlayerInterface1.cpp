...
void CyPlayerPythonInterface1(python::class_<CyPlayer>& x)
{
	...
	x
		...
		//ìåï˚èñéñéçóp
        .def("setNumWorldSpell", &CyPlayer::setNumWorldSpell, "void (int iNum)")
        .def("getNumWorldSpell", &CyPlayer::getNumWorldSpell, "int ()")
        .def("setNumTohoUnitLimit", &CyPlayer::setNumTohoUnitLimit, "void (int iNum)")
        .def("getNumTohoUnitLimit", &CyPlayer::getNumTohoUnitLimit, "int ()")
        .def("setNumTohoUnit", &CyPlayer::setNumTohoUnit, "void (int iNum)")
        .def("getNumTohoUnit", &CyPlayer::getNumTohoUnit, "int ()")
        .def("setMysteryiumFlag", &CyPlayer::setMysteryiumFlag, "void (int iNum)")
        .def("getMysteryiumFlag", &CyPlayer::getMysteryiumFlag, "int ()")
        .def("setAIPromotionRoute", &CyPlayer::setAIPromotionRoute, "void (int iNum)")
        .def("getAIPromotionRoute", &CyPlayer::getAIPromotionRoute, "int ()")
        .def("setNumMyLove", &CyPlayer::setNumMyLove, "void (int index , int iNum)")
        .def("getNumMyLove", &CyPlayer::getNumMyLove, "int (int index)")
