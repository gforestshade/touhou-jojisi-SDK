...
public:
	...
	//ìåï˚èñéñéçóp
	void setNumCirnoFreeze(int iNum);
	int getNumCirnoFreeze();
	void setOriginalBounu(int iNum);
	int getOriginalBounu();
	void setOriginalTerrain(int iNum);
	int getOriginalTerrain();
	void setNumVortexTrun(int iNum);
	int getNumVortexTrun();
...
protected:
	...
	//ìåï˚èñéñéçóp
	int m_iCirnoFreeze;
	int m_iOriginalBounu;
	int m_iOriginalTerrain;
	int m_iVortexTurn;
